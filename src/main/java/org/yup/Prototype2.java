...
import static java.util.Comparator.comparing;
    ...
    public class Prototype2 {
        ...
        public static void main(String[] args) throws IOException {
            JFrame frame = new JFrame("Billionaire Mansion");
            ...
            String name = javax.swing.JOptionPane.showInputDialog("Please enter 1 to start the application");
            //System.out.println("Please enter 1 to start the application");
            //String i = scan.nextLine();


            while(name.equalsIgnoreCase("1")){

                String choice = javax.swing.JOptionPane.showInputDialog("Welcome to Billionaire Mansion\nPress D to make an Deposit\n" +
                        "Press P to make an Payment\nPRESS L TO VIEW THE LEDGER SCREEN\nPRESS E TO EXIT");
                ...
                */
                ...
                if(choice.equalsIgnoreCase("D")){
                   // AddDeposit();
                    JOptionPane.showMessageDialog(null, "YOU JUST MADE A DEPOSIT");
